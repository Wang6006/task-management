...
async function submit() {
  ...
  try {
    ...
    error.value = e.message || 'Tạo người dùng thất bại!';
  } finally {
    loading.value = false;
  }
}
  ...
  <div class="user-add-form">
    ...
    <form @submit.prevent="submit" class="form">
      ...
      <div class="mb-3">
        ...
        <input v-model="form.password" class="form-control" type="password" required minlength="6" />
      </div>
      <div class="mb-3">
      ...
      <button class="btn btn-primary" :disabled="loading">{{ loading ? 'Đang tạo...' : 'Tạo người dùng' }}</button>
    </form>
  </div>
</template>
